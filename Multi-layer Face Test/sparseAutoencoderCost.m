...
%     end
% end
sparsity=(-sparsityParam./max(mp,10^-10)+(1-sparsityParam)./max((1-mp),10^-10));
...
kld =sparsityParam.*log(sparsityParam./max(x,10^-10))+(1-sparsityParam).*log((1-sparsityParam)./max((1-x),10^-10));
end
